...
|:--|:--|--:|--:|--:|--:|--:|--:|--:|--:|
| DSO_4 | down | 15 | 0 | 15 | 11.0 | 30.9 | 0.00 | 38.79 | 10.0 |
| DSO_4 | up | 15 | 0 | 15 | 11.0 | 39.7 | 0.07 | 35.78 | 10.0 |
| __pooled__ | both | 30 | 0 | 30 | 11.0 | 38.6 | 0.03 | 37.45 | 10.0 |
...
|:--|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| DSO_4 | down | 15 | 11.0 | 30.9 | 40 | 0.00 | 10.0 | 107.9 | 0.07 | 0 | 0 |
| DSO_4 | up | 15 | 11.0 | 39.7 | 46 | 0.07 | 10.0 | 85.5 | 0.07 | 0 | 0 |
| __pooled__ | both | 30 | 11.0 | 38.6 | 46 | 0.03 | 10.0 | 96.7 | 0.07 | 0 | 0 |
...
- run: `2026-08-21T17:28:14.171556+02:00`
...
- command: `Z:\Python_Projekte\qOFO_GH\results\_codex_ninner_gwd_20260821\experiments\ch_9_parameter_selection\ch_9_1_ninner_isolated_sts.py --workers 16 --max-step-mvar 10 --case-design balanced_half --dso-v-authority-override 10 --dso-der-weight-override 610.9483260850913 --dsos DSO_4 --out Z:\Python_Projekte\qOFO_GH\docs\data\2026-08-21_ch9_ninner_10mvar_corrected --label dso4_gw_der_610p948_relief10_diagnostic`